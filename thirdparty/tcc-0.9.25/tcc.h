...
#elif defined(SIRPAIR_TCC)

#include "sirpair_host_includes.h"
...
#endif /* !CONFIG_TCCBOOT && !SIRPAIR_TCC */
...
#define TCC_TARGET_I386
    ...
    !defined(TCC_TARGET_C67) && !defined(TCC_TARGET_X86_64) && !defined(SIRPAIR_TCC)
...
#if !defined(_WIN32) && !defined(CONFIG_TCCBOOT) && !defined(SIRPAIR_TCC)
